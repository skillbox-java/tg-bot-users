...
async def get_mod_group(message: types.Message, state: FSMContext) -> None:
    """
    Функция доя получения ID группы модераторов при добавлениий новой записи в таблицу соотв. групп
